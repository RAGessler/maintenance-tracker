...
export type { Bootstrap, CreateVehicleInput, GarageVehicle, MaintenanceStore, RecoveryState, TrackingSnapshot, UpdateVehicleInput, Vehicle } from './src/MaintenanceStore';
