...
export type { AppendManualOdometerReadingInput, Bootstrap, CompleteMaintenanceScheduleInput, CreateMaintenanceRecordInput, CreateMaintenanceScheduleInput, CreateVehicleInput, GarageVehicle, LocationPermissionStatus, MaintenanceRecord, MaintenanceSchedule, MaintenanceStore, ManualOdometerReading, OdometerFacts, RecoveryState, ReviewTripInput, TrackingSetup, TrackingSnapshot, Trip, TripRevision, UpdateMaintenanceRecordInput, UpdateMaintenanceScheduleInput, UpdateVehicleInput, Vehicle } from './src/MaintenanceStore';
