...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: TorqueColors.canvas }, safeArea: { flex: 1 }, content: { gap: Spacing.three, padding: Spacing.four }, title: { color: TorqueColors.text, fontSize: 34, fontWeight: '700' }, subtitle: { color: TorqueColors.secondary }, group: { gap: Spacing.two }, groupTitle: { color: TorqueColors.text, fontSize: 20, fontWeight: '700' }, card: { backgroundColor: TorqueColors.card, borderRadius: 14, padding: Spacing.three, flexDirection: 'row', gap: Spacing.two, justifyContent: 'space-between', alignItems: 'center' }, service: { color: TorqueColors.text, fontSize: 17, fontWeight: '700' }, vehicle: { color: TorqueColors.secondary, marginTop: Spacing.half }, detail: { color: TorqueColors.secondary, fontSize: 12, marginTop: Spacing.one }, status: { color: TorqueColors.primary, fontWeight: '600', maxWidth: '42%', textAlign: 'right' }, muted: { color: TorqueColors.secondary }, error: { color: TorqueColors.error }, empty: { gap: Spacing.two }, action: { alignSelf: 'flex-start', backgroundColor: TorqueColors.primary, borderRadius: 10, minHeight: 44, justifyContent: 'center', paddingHorizontal: Spacing.three }, actionText: { color: '#FFFFFF', fontWeight: '700' },
});
